...
For stakeholders definitions, see <<stakeholders>>.

[[e1-terms]]
==== `{counter:e1}` Terms

[[smartHome]]
{smartHome}:: The system under development: a home featuring a broad range of automated services to make it, e.g., more convenient, safer, or less costly to live in.
